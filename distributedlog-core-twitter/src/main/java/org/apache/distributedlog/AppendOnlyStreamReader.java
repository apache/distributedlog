...
public class AppendOnlyStreamReader extends InputStream {
    ...
    private final org.apache.distributedlog.api.DistributedLogManager dlm;
    private org.apache.distributedlog.api.LogReader reader;
     ...
     */
    AppendOnlyStreamReader(org.apache.distributedlog.api.DistributedLogManager dlm)
        throws IOException {
        this.dlm = dlm;
    ...
    private static LogRecordWithInputStream nextLogRecord(org.apache.distributedlog.api.LogReader reader) throws IOException {
    ...
    public boolean skipTo(long position) throws IOException {
        ...
        org.apache.distributedlog.api.LogReader skipReader = dlm.getInputStream(position);
